...
{
	public class NavigationManyToOne<TEntity, TNavigation> : Navigation, INavigationManyToOne
		...
		where TNavigation : BaseEntity<TNavigation>, new()
	{
		...
		public NavigationManyToOne(IORMContext ormContext,
	...
	public interface INavigationManyToOne { }
}
